        ...
        <div class="container">
            <div class="footer-grid">
                ...
                <div class="footer-brand">
                    ...
                    <div class="brand-description">Lorem ipsum dolor sit amet consectetur adipisicing elit. </div>
                </div>
                    ...
                    <div class="social-links">
                      <a href="#" class="social-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                <path d="M7 10v4h3v7h4v-7h3l1-4h-4v-2a1 1 0 0 1 1-1h3V3h-3a5 5 0 0 0-5 5v2H7" />
                            </svg>
                        </a>
            ...
            <div class="footer-copyright">
                © 2025 Rayito de sol - Todos los Derechos Reservados.
            </div>
        </div>
    </footer>
</template>
